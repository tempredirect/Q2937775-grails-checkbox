                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="groups"><g:message code="person.groups.label" default="Groups" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: person, field: 'groups', 'errors')}">
                                    <g:select name="groups" from="${q2937775.grails.checkbox.Group.list()}" multiple="yes" optionKey="id" size="5" value="${person?.groups*.id}" />
                                </td>
                            </tr>
